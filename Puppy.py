...
class Puppy:
    # this is from the website. I'm using it to program some of my code.
    ...
    UP_EYES = Image(ImageFile.UP)
    DOWN_EYES = Image(ImageFile.DOWN)
    MIDDLE_LEFT_EYES = Image(ImageFile.MIDDLE_LEFT)
    MIDDLE_RIGHT_EYES = Image(ImageFile.MIDDLE_RIGHT)
    ...
    def __init__(self):
        ...
        # set speaker attributes 
        self.ev3.speaker.set_speech_options(voice='f1')
        self.ev3.speaker.set_volume(volume=75)
